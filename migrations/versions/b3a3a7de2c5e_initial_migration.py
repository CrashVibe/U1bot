...
def downgrade(name: str = "") -> None:
    ...
    op.create_table('chat_time_total',
    sa.Column('group_id', mysql.BIGINT(display_width=20), autoincrement=True, nullable=False),
    sa.Column('user_time_map', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.Column('user_message_map', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.PrimaryKeyConstraint('group_id'),
    mysql_collate='utf8mb4_uca1400_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
    op.create_table('BilibiliAccount',
    ...
    op.create_table('chat_time',
    sa.Column('group_id', mysql.BIGINT(display_width=20), autoincrement=True, nullable=False),
    sa.Column('timestamp_map', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.Column('today_time_map', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.Column('today_message_map', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.Column('today_remind_time', mysql.LONGTEXT(charset='utf8mb4', collation='utf8mb4_bin'), nullable=False),
    sa.PrimaryKeyConstraint('group_id'),
    mysql_collate='utf8mb4_uca1400_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
